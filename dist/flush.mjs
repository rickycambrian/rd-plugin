...
function writeSpool(spoolDir, traces) {
  ...
  for (const trace of traces) {
    ...
    const filePath = path6.join(spoolDir, spoolFileName(trace.claudeSessionId, trace.turnIndex));
...
async function flushDirect(config, claudeSessionId, events, summary, transcriptPath, legacyStreamMaxSequence, state) {
