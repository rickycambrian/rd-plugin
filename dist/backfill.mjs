...
var str = (v) => ({ String: v });
var int = (v) => ({ Integer: v });
var strArray = (vs) => ({ Array: vs.map(str) });
...
function buildSessionKindOp(sessionNodeId, initialPrompt, entrypoint, branch) {
...
function buildSessionStubOperation(sessionNodeId, walletAddress, agentId, claudeSessionId) {
  return {
    ...
    mode: "merge",
    properties: {
      agent_id: str2(agentId),
      session_id: str2(claudeSessionId),
      claude_session_id: str2(claudeSessionId),
      wallet_address: str2(walletAddress.toLowerCase()),
      source: str2("claude-code-hooks"),
