...
// ../rickydata_SDK/packages/core/dist/kfdb/agent-chat-trace.js
...
// ../rickydata_SDK/packages/core/dist/kfdb/claude-code-hook-trace.js
...
// ../rickydata_SDK/packages/core/dist/kfdb/codex-hook-trace.js
...
// ../rickydata_SDK/packages/core/dist/kfdb/hermes-hook-trace.js
...
// ../rickydata_SDK/packages/core/dist/kfdb/rickydata-graph.js
var GraphEntityKind;
...
// ../rickydata_SDK/packages/core/dist/kfdb/session-link.js
...
// ../rickydata_SDK/packages/core/dist/kfdb/memory-v1.js
var OPEN_QUESTION_LABEL = GraphEntityKind.OpenQuestion;

// ../rickydata_SDK/packages/core/dist/kfdb/wiki-v1.js
...
async function writeLegacyStream(cfg, claudeSessionId, events, startAfterSequence, summary, transcriptPath) {
...
// src/lib/backfill-core.ts
function selectBackfillCandidates(files, opts) {
...
`);
  ...
  for (const session of candidates) {
    ...
    try {
      if (sink === "gateway") {
        writeGatewayUnit({ spoolDir, walletAddress, claudeSessionId, events, summary });
      } else {
      ...
      log("warn", "backfill session failed", { id: session.id, error: err.message });
    }
    state.backfilled[session.id] = true;
...
main().catch((err) => {
  ...
  process.stdout.write(`backfill error: ${err.message}
`);
